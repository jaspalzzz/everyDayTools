  ...
  return (
    <div className="prose-content">
      ...
      <p>
        ...
        Your employer can reclaim SSP from HMRC if they qualify as a small employer (average monthly
      ...
      <p>
        SSP is the statutory minimum. Many employers offer enhanced (contractual) sick pay — paying
        full or partial salary for a period before dropping to SSP. Check your employment contract or
        staff handbook. Common schemes offer:
      </p>
      <ul>
        <li>Full pay for 1–3 months, then half pay for 1–3 months, then SSP</li>
        <li>A fixed number of full-pay sick days per year (e.g., 10 days full pay, then SSP)</li>
      </ul>
      <p>
        Enhanced sick pay is contractual — if your employer has agreed to pay it, they must do so.
        If they refuse to pay contractual sick pay, you can bring an unlawful deduction from wages
        claim in the Employment Tribunal.
      </p>

      <h2>Notification requirements</h2>
      <p>
        You must notify your employer of your absence in accordance with their sick leave policy.
        Most employers require notification on the first day of absence (or by a specified time).
        Failure to notify can result in SSP being withheld for the uncertified days — but your
        employer cannot withhold SSP indefinitely or permanently for notification failures.
      </p>
      <p>
        For absences of <strong>7 days or less</strong>, you can self-certify your illness using an
        SC2 form or your employer&apos;s own self-certification form. For absences longer than 7 days
        (including weekends), you need a <strong>fit note (Statement of Fitness for Work)</strong>
        from your GP or a hospital doctor.
      </p>

      <h2>What if your employer refuses to pay SSP?</h2>
      <p>
        If your employer refuses to pay SSP and you believe you qualify, you can:
      </p>
      <ol>
        <li>
          <strong>Ask your employer to confirm in writing</strong> why SSP has been withheld. They
          should provide an SSP1 form or equivalent explanation.
        </li>
        <li>
          <strong>Contact HMRC</strong> (0300 200 3500 or via GOV.UK). HMRC enforces SSP compliance
          and can investigate disputes between employees and employers. HMRC can require your employer
          to pay and can impose penalties for persistent non-payment.
        </li>
        <li>
      ...
      <h2>SSP and dismissal</h2>
      <p>
        Your employer cannot dismiss you simply because you are on sick leave — but they can eventually
        dismiss you if: your long-term absence makes it impossible for them to continue the employment
        relationship, and they have followed a fair capability procedure (including medical evidence,
        consultation, and exploration of adjusted roles or phased return). If dismissal is connected
        to a disability (as long-term illness often is), the employer must also have complied with
        the duty to make reasonable adjustments under the Equality Act 2010.
      </p>
      <p>
        If you are dismissed because of a disability-related illness, you may have both an unfair
        dismissal claim and a disability discrimination claim. Seek specialist advice if this applies
        to you.
      </p>
    </div>
  );
