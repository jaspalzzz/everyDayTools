    ...
    <div className="mx-auto max-w-content px-5">
      ...
      <section className="py-12 text-center sm:py-16">
        ...
        <h1 className="mx-auto mt-3 max-w-xl text-3xl font-medium leading-tight tracking-tight text-ink sm:text-4xl">
          Pay rights calculators that know{" "}
          <span className="text-brand-600">your country&apos;s rules</span>
        </h1>
      ...
      <section
        ...
        className="mx-auto mt-14 grid max-w-2xl grid-cols-2 gap-px overflow-hidden rounded-xl border border-surface-line bg-surface-line sm:grid-cols-4"
      >
        {FEATURES.map((f) => (
          <dl key={f.title} className="flex flex-col items-center bg-white px-4 py-5 text-center">
            <dd aria-hidden="true">
