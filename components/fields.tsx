  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <select
        ...
        className="w-full min-w-0 rounded-md border border-surface-control bg-white px-3 py-2.5 text-sm text-ink outline-none focus:border-brand-600 focus:ring-2 focus:ring-brand-50"
        aria-describedby={hint ? `${id}-hint` : undefined}
      >
        {options.map((o) => (
