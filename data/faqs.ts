...
export const FAQS: FaqPageMeta[] = [
  ...
  },
  {
    ...
    shortAnswer: "Statutory Sick Pay (SSP) is £116.75 per week for up to 28 weeks. It starts from the 4th day of illness — the first 3 days are unpaid 'waiting days'. You must earn above the Lower Earnings Limit to qualify.",
    answer: [
      "Statutory Sick Pay (SSP) for 2025/26 is £116.75 per week. It is paid by your employer for up to 28 weeks of incapacity. There are 3 unpaid 'waiting days' (the first 3 consecutive days of sickness) before SSP starts — so SSP is only payable from day 4. Once you have exhausted 28 weeks of SSP, you must claim Employment and Support Allowance (ESA) from DWP instead.",
      "To qualify for SSP you must: be classed as an employee (not a worker or self-employed); have average earnings at or above the Lower Earnings Limit (£125/week for 2025/26); have been ill for at least 4 consecutive days (including non-working days); and have given your employer proper notice of your absence. Agency workers, people on zero-hours contracts, and those earning below the LEL do not qualify for SSP but may qualify for Universal Credit instead.",
      "SSP is paid through your employer's payroll and is subject to income tax and National Insurance in the usual way. Your employer can recover some or all of the cost from HMRC if they qualify as a small employer. If you are ill for repeated short periods (rather than one continuous period), you may be able to 'link' absences within 8 weeks of each other — linked periods count as a single period of incapacity, and waiting days only apply once per linked period.",
    ],
    country: "UK",
