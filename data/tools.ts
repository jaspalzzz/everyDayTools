...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    seoTitle: "Settlement & Compromise Agreement Calculator UK 2026",
    description:
      "Estimate a UK employment settlement or compromise agreement — redundancy pay, PILON, ex gratia compensation and the £30,000 tax-free threshold.",
    region: "UK",
  ...
  },
  {
    ...
    seoTitle: "Unfair Dismissal & Tribunal Compensation Calculator UK",
    description:
      "Estimate UK unfair dismissal and Employment Tribunal compensation — basic award, compensatory award, ACAS uplift, Vento bands and possible reductions.",
    region: "UK",
    icon: "ti-gavel",
    hero: true,
    tier: 1,
  ...
  },
  {
    ...
    seoTitle: "UK Notice Period Calculator 2026 | Statutory & Contractual",
    description:
      "Calculate your UK or Canadian notice period from service and contract terms, including whether one month, four weeks or the statutory minimum applies.",
    region: "UK/CA",
    icon: "ti-calendar-clock",
    hero: true,
    tier: 1,
    category: "leaving-job",
    related: ["redundancy-pay-calculator", "severance-pay-calculator", "continuous-service-calculator"],
  },
  {
    slug: "continuous-service-calculator",
    name: "Continuous employment calculator",
    shortName: "Continuous service",
    seoTitle: "UK Continuous Employment Calculator | Service Length",
    description:
      "Calculate complete years, months and weeks of UK continuous employment and check the common one-month and two-year service thresholds.",
    region: "UK",
    icon: "ti-timeline-event",
    hero: false,
    tier: 2,
    category: "leaving-job",
    related: ["notice-period-calculator", "redundancy-pay-calculator", "probation-end-date-calculator"],
  },
  {
    slug: "probation-end-date-calculator",
    name: "Probation end date calculator",
    shortName: "Probation end date",
    seoTitle: "UK Probation End Date Calculator | Contract Review Date",
    description:
      "Add a probation period to your employment start date and see the calendar review date, preceding full day and contract checks to make.",
    region: "UK",
    icon: "ti-calendar-check",
    hero: false,
    tier: 2,
    category: "leaving-job",
    related: ["continuous-service-calculator", "notice-period-calculator", "working-days-calculator"],
  },
  {
